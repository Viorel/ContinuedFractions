...
namespace ContinuedFractionsLibrary
{
    ...
    public class Fraction : IEquatable<Fraction>, IComparable<Fraction>
    {
        ...
        public Fraction ReduceNoE( ICancellable cnc, BigInteger maxVal )
        {
            ...
            if( CompareTo( cnc, new Fraction( -1, 1, -1000 ) ) > 0 && CompareTo( cnc, new Fraction( 1, 1, -1000 ) ) < 0 )
            {
            ...
            if( CompareTo( cnc, MinusOne ) > 0 && CompareTo( cnc, One ) < 0 ) // ]-1...+1[
            {
            ...
            if( CompareTo( cnc, new Fraction( -1, 1, 1000 ) ) > 0 && CompareTo( cnc, new Fraction( 1, 1, 1000 ) ) < 0 ) // not in [-1...+1], but not too large (E not too large)
            {
                BigInteger n1 = BigInteger.Abs( N );
                BigInteger d1 = D;
                BigInteger e1 = E;
        ...
        {
            return Equals( ICancellable.NonCancellable, other );
        }
